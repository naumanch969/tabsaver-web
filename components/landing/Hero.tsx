  ...
  return (
    <Section className="pt-32! md:pt-40! pb-32! md:pb-40!">
      <Container className="flex flex-col! items-center! text-center! mx-auto!">
        <div className="flex flex-col! items-center! text-center! gap-10! md:gap-14! max-w-5xl! mx-auto!">
          <HeroBadge />
          <HeroTitle />
          <HeroDescription />
          <HeroActions />
...
const HeroTitle = () => (
  <motion.div 
    ...
    className="space-y-4!"
  >
    <SerifHeading as="h1" className="text-5xl! md:text-7xl! leading-[0.95] text-balance tracking-tighter">
...
const HeroDescription = () => (
  <motion.p 
    ...
    className="text-base! md:text-lg! max-w-xl! mx-auto! leading-relaxed text-balance font-medium text-t2 px-4!"
  >
...
const HeroActions = () => (
  ...
  >
    <Link href="/sign-in" className="w-full sm:w-auto">
      <PremiumButton variant="primary" className="w-full! sm:w-auto! text-xs! py-5! px-10! group rounded-2xl!">
        Download Extension
        <Download size={16} className="group-hover:translate-y-0.5 transition-transform duration-300" />
      </PremiumButton>
    </Link>
    <Link href="/dashboard" className="w-full sm:w-auto">
      <PremiumButton variant="outline" className="w-full! sm:w-auto! text-xs! py-5! px-10! group rounded-2xl!">
        Enter Cloud Vault
