...
export const BroadcastFooter = () => (
  <div className="mt-48!">
      <GlassCard className="p-20! md:p-32! text-center border-white/5! rounded-lg! hover:false">
        <div className="w-24! h-24! bg-accent/10 rounded-lg! flex items-center justify-center mx-auto! mb-12! border border-accent/20">
